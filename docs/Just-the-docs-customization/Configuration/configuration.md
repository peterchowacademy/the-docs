...
See [the Code documentation]({% link docs/Just-the-docs-customization/ui-components/code.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Callouts]({% link docs/Just-the-docs-customization/ui-components/callouts.md %}) for more information.
