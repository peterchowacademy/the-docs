...
Wrap the button in a container that uses the [font-size utility classes]({% link docs/Just-the-docs-customization/utilities/utilities-extended/typography.md %}) to scale buttons:
...
Use the [margin utility classes]({% link docs/Just-the-docs-customization/utilities/utilities-extended/layout.md %}#spacing) to add spacing between two buttons in the same block.
