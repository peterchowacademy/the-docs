...
When you have [configured]({% link docs/Just-the-docs-customization/Configuration/configuration.md %}#callouts) the  `color` and (optional) `title` for a callout, you can apply it to a paragraph, or to a block quote with several paragraphs, as illustrated below.[^postfix]
